...
public class VerboseTableTests
    : OrderTest
        , IClassFixture<InventoryBetterTablesFixture>
{
    private InventoryBetterTablesFixture fixture;

    public VerboseTableTests(InventoryBetterTablesFixture fixture)
    {
        this.fixture = fixture;
    }

    [Theory]
    [MemberData(nameof(VerboseTableData.Insert01)
        , MemberType= typeof(VerboseTableData))]
    ...
    [Theory]
    [MemberData(nameof(VerboseTableData.Read01)
        , MemberType= typeof(VerboseTableData))]
