    ...
    public new static IEnumerable<object[]> Read01 =>
        new List<object[]>
        {
            new object[] 
            {
                ...
                , GetReadCmd()
                ,    "┌{idcol}┬───────────┬────────────────────┐\r\n"
                +   $"│ \u001b[38;2;250;250;210m {nameof(Item.Id)} \u001b[0m │ \u001b[38;2;0;128;0m   {nameof(Item.Name)}  \u001b[0m │ \u001b[38;2;220;20;60m    {nameof(Item.Description)}   [0m │\r\n"
                +    "├{idcol}┼───────────┼────────────────────┤\r\n"
                +   $"│ \u001b[38;2;250;250;210m{{id}}\u001b[0m │ \u001b[38;2;0;128;0m{Name}\u001b[0m │ \u001b[38;2;220;20;60m{Description}[0m │\r\n"
                +    "└{idcol}┴───────────┴────────────────────┘\r\n"
            }
        };
}